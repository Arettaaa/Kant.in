<?php $__env->startSection('title', 'Masuk - Kant.in'); ?>
    ...
    <div class="w-full md:w-1/2 flex flex-col min-h-screen overflow-y-auto">
        ...
        <div class="flex-1 flex flex-col px-10 pt-7 pb-10" style="background-color:#FFFFFF;">
            ...
            <div class="mb-4 p-3 rounded-xl bg-red-50 border-l-4 border-red-500 text-red-600 text-sm font-medium">
                <i class="fa-solid fa-circle-exclamation mr-2"></i> <?php echo e($errors->first('message')); ?>

            </div>
            <?php endif; ?>

            
                <form id="loginForm" action="<?php echo e(route('login.post')); ?>" method="POST" class="space-y-4 mt-4">
                    <?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\arett\AndroidStudioProjects\Kantin\backend-new\resources\views/auth/login.blade.php ENDPATH**/ ?>