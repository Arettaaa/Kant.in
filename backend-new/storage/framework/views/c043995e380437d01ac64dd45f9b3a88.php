...
<style>
    ...
    .save-btn:hover { filter: brightness(1.08); transform: translateY(-1px); box-shadow: 0 8px 24px rgba(255,105,0,0.3); }
            ...
            <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-8 max-w-2xl mx-auto mt-4">
                ...
                <form id="editProfileForm" action="<?php echo e(route('pelanggan.profil.update')); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="flex justify-center mb-10">
                        ...
                        <input type="file" name="photo_profile" id="avatarInput" accept="image/*" class="hidden" onchange="previewAvatar(this)">
                    </div>
                    ...
                    <div class="flex flex-col gap-6">
                        ...
                        <button type="submit" class="save-btn mt-6 w-full py-4 rounded-2xl text-white font-extrabold text-sm shadow-lg flex items-center justify-center gap-2" style="background: linear-gradient(135deg, #FF6900, #ea580c);">
...
<div id="saveModal" class="fixed inset-0 z-50 flex items-center justify-center" style="background:rgba(0,0,0,0.4); backdrop-filter:blur(5px);">
    <div class="modal-card bg-white rounded-3xl shadow-2xl w-[360px] mx-4 overflow-hidden">
        ...
        <div class="px-8 pt-8 pb-8 flex flex-col items-center gap-4">
            <div class="check-anim w-16 h-16 rounded-full flex items-center justify-center shadow-lg" style="background:linear-gradient(135deg,#22c55e,#16a34a);">
            ...
            <button onclick="closeSaveModal()" class="w-full py-3.5 rounded-2xl border-2 border-gray-200 text-gray-600 font-bold text-sm hover:bg-gray-50 transition-all">
                Tutup
            </button>
        </div>
    </div>
