        ...
        <div
            ...
            <div
                ...
                <div class="relative w-28 h-28 mx-auto mb-4">
                    ...
                    <img src="<?php echo e(asset('storage/'.$user->photo_profile)); ?>"
                        class="w-full h-full rounded-full object-cover border-4 border-white shadow-md">
                    <?php else: ?>
                    <div
                        class="w-full h-full rounded-full bg-orange-100 flex items-center justify-center border-4 border-white shadow-md">
                ...
                <div class="flex items-center justify-center gap-2 mb-8">
                    <span
                        class="px-4 py-1.5 bg-gray-50 rounded-full text-[11px] font-black text-gray-400 uppercase tracking-widest border border-gray-100">
            ...
            <div class="w-full max-w-4xl space-y-8">
                <div>
                    <h3 class="text-sm font-black text-gray-900 uppercase tracking-widest mb-4 ml-2">Manajemen Profil
                    </h3>
                    <div class="bg-white rounded-[32px] overflow-hidden shadow-sm border border-gray-100">
                        ...
                        <a href="/profil/keamanan"
                            class="flex items-center justify-between p-6 hover:bg-gray-50 transition-all">
                            <div class="flex items-center gap-5">
                                <div
                                    class="w-12 h-12 rounded-2xl bg-green-50 flex items-center justify-center text-green-500">
