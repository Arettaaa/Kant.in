...
<div class="w-full min-h-screen flex" style="background-color:#F9FAFB;">
    ...
    <div class="w-full md:w-1/2 flex flex-col min-h-screen overflow-y-auto">
        ...
        <div class="flex-1 flex flex-col px-10 pt-8 pb-10">
            ...
            {{-- Back link --}}
            <a href="/login" class="flex items-center gap-2 text-sm font-semibold text-gray-400 hover:text-gray-600 transition-all mb-6 w-fit">
            ...
            <div class="mb-7">
                ...
                <p class="text-sm text-gray-400 font-medium">Masukkan email atau nomor HP untuk menerima kode OTP.</p>
            </div>
...
<script>
    ...
    function kirimOTP() {
        window.location.href = '/lupa-sandi/verifikasi';
    }
</script>
@endpush