...
<div class="flex w-full h-screen bg-[#F9FAFB] overflow-hidden text-start">
    ...
    <aside
        ...
        <form method="POST" action="/logout" class="mt-auto">
            @csrf
            <button type="submit"
                class="flex items-center gap-3 px-4 py-4 rounded-2xl text-[15px] font-bold text-gray-400 hover:text-red-500 hover:bg-red-50 transition-all border-t border-gray-50 w-full text-start">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
