...
<div class="flex w-full h-screen bg-[#F9FAFB] overflow-hidden text-start font-sans">
    ...
    <aside class="w-[260px] h-screen bg-white flex flex-col py-8 px-6 shadow-sm flex-shrink-0 z-20 border-r border-gray-100">
        ...
        <nav class="flex flex-col gap-2 flex-1">
            ...
            <a href="/admin/global/transaksi" class="sidebar-link flex items-center gap-3 px-4 py-3.5 rounded-2xl text-[15px] font-bold text-gray-400 hover:bg-gray-50 transition-all">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                Transaksi
            </a>

            {{-- Notifikasi AKTIF --}}
            <a href="/admin/global/notifikasi" class="sidebar-link active flex items-center justify-between px-4 py-3.5 rounded-2xl text-[15px] font-bold transition-all">
                <div class="flex items-center gap-3">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"/></svg>
                    Notifikasi
                </div>
                <span id="sidebarBadge" class="w-5 h-5 flex items-center justify-center rounded-full text-[10px] font-black text-white shadow-sm" style="background-color:#FF6900;">2</span>
            </a>
    ...
    <main class="flex-1 h-screen overflow-y-auto hide-scrollbar flex flex-col">
        ...
        <div class="p-10 space-y-4 max-w-4xl w-full text-start">
            ...
            <div id="notif-1" class="notif-card unread rounded-3xl border p-5 flex items-start gap-4">
                ...
                <div class="flex-1 min-w-0">
                    <div class="flex items-start justify-between gap-3">
                        <p class="text-sm font-extrabold text-gray-900">Pendaftaran Kantin Baru: Warung Bu Ani</p>
                        <div class="flex items-center gap-2 flex-shrink-0">
                            <span class="text-xs text-gray-400 font-semibold">10 mnt lalu</span>
            ...
            {{-- Notif 2 — Unread --}}
            <div id="notif-2" class="notif-card unread rounded-3xl border p-5 flex items-start gap-4">
                <div class="notif-icon-wrap" style="background-color:#FFF3E8;">
                    <i class="fa-solid fa-wave-square text-lg" style="color:#FF6900;"></i>
                </div>
                <div class="flex-1 min-w-0">
                    <div class="flex items-start justify-between gap-3">
                        <p class="text-sm font-extrabold text-gray-900">Pembaruan Sistem Selesai</p>
                        <div class="flex items-center gap-2 flex-shrink-0">
                            <span class="text-xs text-gray-400 font-semibold">1 jam lalu</span>
                            <div class="w-2.5 h-2.5 rounded-full flex-shrink-0" style="background-color:#FF6900;"></div>
                        </div>
                    </div>
                    <p class="text-sm text-gray-500 font-medium mt-1 leading-relaxed">Sinkronisasi gerbang pembayaran QRIS berhasil diselesaikan tanpa kesalahan.</p>
                </div>
            </div>

            {{-- Notif 3 — Read --}}
            <div id="notif-3" class="notif-card read rounded-3xl border border-gray-100 p-5 flex items-start gap-4">
                <div class="notif-icon-wrap bg-gray-100">
                    <i class="fa-solid fa-shield-halved text-lg text-gray-400"></i>
                </div>
                <div class="flex-1 min-w-0">
                    <div class="flex items-start justify-between gap-3">
                        <p class="text-sm font-extrabold text-gray-700">Akses Admin Baru Diberikan</p>
                        <span class="text-xs text-gray-400 font-semibold flex-shrink-0">3 jam lalu</span>
                    </div>
                    <p class="text-sm text-gray-400 font-medium mt-1">Akses admin diberikan kepada budi.admin@kant.in.</p>
                </div>
            </div>
