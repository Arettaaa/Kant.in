    ...
    <main class="flex-1 h-screen overflow-y-auto hide-scrollbar flex flex-col text-start">
        ...
        <header class="w-full bg-white border-b border-gray-100 px-10 py-6 sticky top-0 z-50 flex justify-between items-center shadow-sm text-start">
            ...
            <div class="flex items-center gap-6 text-start">
                <div class="relative text-start" id="bellWrapper">
                    ...
                    <div id="notifDropdown" class="notif-dropdown hidden text-start" style="right:-20px;">
                        <div class="flex items-center justify-between px-5 py-4 border-b border-gray-50 text-start">
                            ...
                            <span class="text-xs font-black px-2.5 py-1 rounded-xl text-start" style="background-color:#FFF3E8; color:#FF6900;">2 Baru</span>
                        </div>
                        <div class="p-5 flex items-start gap-3 text-start">
                            <div class="w-10 h-10 bg-orange-50 rounded-xl flex items-center justify-center text-orange-600 flex-shrink-0 text-start"><i class="fa-solid fa-store text-sm text-start"></i></div>
                            <div class="flex-1 text-start"><p class="text-sm font-extrabold text-gray-900 leading-tight text-start">Pendaftaran Kantin Baru</p><p class="text-[11px] text-gray-400 mt-1 text-start">10 mnt lalu</p></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-4 group text-start">
                    ...
                    <div class="w-12 h-12 rounded-full bg-[#FFF3E8] flex items-center justify-center text-[#FF6900] font-black text-lg border border-orange-100 shadow-sm transition-all group-hover:bg-[#FF6900] group-hover:text-white">A</div>
                </div>
            </div>
        </header>
        ...
        <div class="p-10 flex flex-col items-center justify-start flex-1 bg-[#F9FAFB] text-start">
            ...
            <div class="w-full max-w-xl mb-8 flex items-center gap-4 text-start">
                <a href="/admin/global/pengaturan" class="w-10 h-10 rounded-full bg-white border border-gray-100 flex items-center justify-center text-gray-400 hover:text-[#FF6900] transition-all shadow-sm">
            ...
            <div class="w-full max-w-xl bg-white p-12 rounded-[44px] border border-gray-100 shadow-sm text-start">
                <form action="#" method="POST" class="space-y-8 text-start">
                    @csrf
                    @method('PUT')

                    {{-- Kata Sandi Saat Ini --}}
                    <div class="text-start">
                        <label class="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] mb-3 block ml-2 text-start">Kata Sandi Saat Ini</label>
                        <div class="relative text-start">
                            <i class="fa-solid fa-lock absolute left-6 top-1/2 -translate-y-1/2 text-gray-300 text-start"></i>
                            <input type="password" placeholder="Masukkan kata sandi saat ini" 
                                class="input-custom w-full pl-14 pr-6 py-5 rounded-[22px] bg-[#F9FAFB] text-[14px] font-bold text-gray-700 outline-none border-none text-start">
                        </div>
                    </div>

                    {{-- Kata Sandi Baru --}}
                    <div class="text-start">
                        <label class="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] mb-3 block ml-2 text-start">Kata Sandi Baru</label>
                        <div class="relative text-start">
                            <i class="fa-solid fa-lock absolute left-6 top-1/2 -translate-y-1/2 text-gray-300 text-start"></i>
                    ...
                    <div class="text-start">
                        <label class="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] mb-3 block ml-2 text-start">Konfirmasi Kata Sandi Baru</label>
                        <div class="relative text-start">
                            <i class="fa-solid fa-lock absolute left-6 top-1/2 -translate-y-1/2 text-gray-300 text-start"></i>
                    ...
                    {{-- Button Group (Perbarui & Batal) --}}
                    <div class="pt-4 flex items-center gap-4 text-start">
                        <button type="submit" 
                            class="px-8 py-4 bg-[#FF6900] text-white rounded-[22px] font-black text-[13px] flex items-center justify-center gap-3 shadow-lg shadow-orange-100 hover:scale-[1.03] transition-all uppercase tracking-widest text-start">
                            <i class="fa-solid fa-rotate text-start"></i> Perbarui Kata Sandi
                        </button>
                        <a href="/admin/global/pengaturan" 
                            class="px-8 py-4 bg-white border border-gray-100 text-gray-400 rounded-[22px] font-black text-[13px] flex items-center justify-center hover:bg-gray-50 transition-all uppercase tracking-widest text-start">
                            Batal
                        </a>
                    </div>
                </form>
