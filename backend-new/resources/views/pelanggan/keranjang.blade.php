...
<div class="flex w-full h-screen bg-[#F9FAFB] overflow-hidden">
    ...
    <div class="flex-1 flex flex-col h-screen overflow-y-auto border-r border-gray-100 bg-white">
        ...
        <div id="cartItems" class="flex flex-col gap-3 px-6 py-6">
            ...
            <div class="cart-item bg-white rounded-2xl p-4 shadow-sm border border-gray-100 flex items-center gap-4" data-id="1" data-price="25000">
            ...
            <div class="cart-item bg-white rounded-2xl p-4 shadow-sm border border-gray-100 flex items-center gap-4" data-id="2" data-price="18000">
                <div class="w-16 h-16 rounded-xl overflow-hidden flex-shrink-0 bg-gray-100">
        ...
        <div id="metodeSection" class="px-6 pb-4">
            ...
            {{-- ✅ BARU: Alamat Pengiriman — muncul saat Kurir Antar dipilih --}}
            <div id="alamatSection" class="alamat-section mt-4">
                <div class="bg-gray-50 rounded-2xl border border-gray-100 p-4">
                    ...
                    {{-- Form edit alamat (hidden by default) --}}
    ...
    <div class="w-[320px] flex-shrink-0 flex flex-col h-screen bg-[#F9FAFB]">
        ...
        <div class="px-7 pb-8">
            <button onclick="window.location.href='/pembayaran'"
...
<script>
    ...
    function changeQty(id, delta) {
        ...
        if (qtys[id] === 0) {
            ...
            if (card) {
                ...
                setTimeout(() => { card.remove(); checkEmpty(); updateSummary(); }, 200);
            }
        } else {
    ...
    function simpanAlamat() {
        ...
        document.getElementById('displayCatatan').textContent = catatan || 'Tidak ada catatan';
        batalEditAlamat();
    }
    ...
    function updateSummary() {
        ...
        document.querySelectorAll('.cart-item').forEach(card => {
            subtotal += parseInt(card.dataset.price) * (qtys[card.dataset.id] || 0);
        });
