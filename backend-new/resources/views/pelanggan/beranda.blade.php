    ...
    <main class="flex-1 flex flex-col h-screen overflow-y-auto bg-[#F9FAFB]">
        ...
        <div class="sticky top-0 z-10 flex items-center justify-between px-10 py-5 bg-white/90 backdrop-blur-md border-b border-gray-100">
            ...
            <div>
                ...
                <h1 class="text-xl font-extrabold text-gray-900 leading-tight">Halo, Yumna! 👋</h1>
            </div>

            {{-- Icons --}}
            <div class="flex items-center gap-3">
                {{-- Riwayat --}}
                <a href="/pesanan" class="w-10 h-10 rounded-2xl bg-gray-50 flex items-center justify-center hover:bg-gray-100 transition-all">                      <svg class="w-5 h-5 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                              d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/>
                    </svg>
                </a>
                {{-- Keranjang --}}
                <a href="/keranjang" class="relative w-10 h-10 rounded-2xl bg-gray-50 flex items-center justify-center hover:bg-gray-100 transition-all">
                    <svg class="w-5 h-5 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                              d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z"/>
                    </svg>
                    <span class="absolute -top-1 -right-1 w-4 h-4 rounded-full text-[10px] font-black text-white flex items-center justify-center"
                          style="background-color:#FF6900;">2</span>
                </a>

                {{-- Avatar --}}
                <a href="/profil" class="w-10 h-10 rounded-full overflow-hidden border-2 border-orange-100 bg-orange-50 flex items-center justify-center cursor-pointer">
        ...
        <div class="px-10 py-8 flex flex-col gap-8">
            ...
            <section>
                ...
                <div class="grid grid-cols-4 gap-3">
                    ...
                    <button onclick="setCategory(this, 'nasi')"
                            ...
                            data-cat="nasi">
                        <div class="cat-icon-wrap w-11 h-11 rounded-2xl flex items-center justify-center" style="background-color:rgba(255,255,255,0.25);">
                            <i class="fa-solid fa-fire text-lg text-white"></i>
                        </div>
            ...
            <section>
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    {{-- Card 1 --}}
                    <a href="/menu/nasi-goreng-spesial" class="food-card bg-white rounded-3xl overflow-hidden shadow-sm border border-gray-100 hover:shadow-md transition-all">
                        <div class="relative h-44 overflow-hidden bg-gray-100">
                            ...
                            <div class="absolute top-3 left-3 flex items-center gap-1 bg-amber-400 text-white text-[11px] font-black px-2 py-1 rounded-xl shadow">
                    ...
                    {{-- Card 2 --}}
                    <a href="/menu/mie-goreng-ayam" class="food-card bg-white rounded-3xl overflow-hidden shadow-sm border border-gray-100 hover:shadow-md transition-all">
                        <div class="relative h-44 overflow-hidden bg-gray-100">
            ...
            <section class="pb-8">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    {{-- Warung Bu Ani --}}
                    <a href="/kantin/warung-bu-ani" class="kantin-card bg-white rounded-3xl p-4 shadow-sm border border-gray-100 flex items-center gap-4">
                        <div class="relative flex-shrink-0">
                            <img src="https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=200&q=80"
                                 alt="Warung Bu Ani"
                                 class="w-16 h-16 rounded-2xl object-cover">
                            <div class="absolute -bottom-1 -right-1 flex items-center gap-0.5 bg-amber-400 text-white text-[10px] font-black px-1.5 py-0.5 rounded-lg shadow">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <span class="inline-flex items-center gap-1 text-[11px] font-bold px-2.5 py-1 rounded-xl" style="background-color:#FFF3E8; color:#FF6900;">
                    ...
                    {{-- Noodle Ninja --}}
                    <a href="/kantin/noodle-ninja" class="kantin-card bg-white rounded-3xl p-4 shadow-sm border border-gray-100 flex items-center gap-4">
                        <div class="relative flex-shrink-0">
                    ...
                    {{-- Fresh Sip --}}
                    <a href="/kantin/fresh-sip" class="kantin-card bg-white rounded-3xl p-4 shadow-sm border border-gray-100 flex items-center gap-4">
                        <div class="relative flex-shrink-0">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <span class="inline-flex items-center gap-1 text-[11px] font-bold px-2.5 py-1 rounded-xl bg-gray-100 text-gray-400">
                    ...
                    {{-- Asian Bowl House --}}
                    <a href="/kantin/asian-bowl-house" class="kantin-card bg-white rounded-3xl p-4 shadow-sm border border-gray-100 flex items-center gap-4">
                        <div class="relative flex-shrink-0">
                            <img src="https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=200&q=80"
                                 alt="Asian Bowl House"
                                 class="w-16 h-16 rounded-2xl object-cover">
                            <div class="absolute -bottom-1 -right-1 flex items-center gap-0.5 bg-amber-400 text-white text-[10px] font-black px-1.5 py-0.5 rounded-lg shadow">
