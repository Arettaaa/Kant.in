        ...
        <div class="px-8 py-8 flex flex-col gap-10 pb-28">
            ...
            <section class="menu-section" data-section="makanan utama">
                ...
                <div class="grid grid-cols-3 gap-4">
                    ...
                    <a href="/menu/nasi-goreng-spesial"
                       ...
                       data-name="nasi goreng spesial">
                        ...
                        <div class="p-3 flex flex-col gap-1">
                            ...
                            <p class="text-xs text-gray-400 leading-snug">Nasi goreng dengan telur & ayam</p>
                    ...
                    <a href="/menu/nasi-kuning-komplit"
                       class="menu-item-card bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100 flex flex-col"
                       data-name="nasi kuning komplit">
                        ...
                        <div class="p-3 flex flex-col gap-1">
                            ...
                            <p class="text-xs text-gray-400 leading-snug">Nasi kuning + lauk lengkap</p>
                            <div class="flex items-center justify-between mt-2">
                    ...
                    <a href="/menu/nasi-uduk"
                       ...
                       data-name="nasi uduk">
                        ...
                        <div class="p-3 flex flex-col gap-1">
                            ...
                            <p class="text-xs text-gray-400 leading-snug">Nasi uduk Betawi + serundeng</p>
                            <div class="flex items-center justify-between mt-2">
                    ...
                    <a href="/menu/nasi-pecel"
                       ...
                       data-name="nasi pecel">
                        ...
                        <div class="p-3 flex flex-col gap-1">
                            ...
                            <p class="text-xs text-gray-400 leading-snug">Sayur segar + sambal kacang</p>
                            <div class="flex items-center justify-between mt-2">
                    ...
                    <a href="/menu/es-teh-manis"
                       ...
                       data-name="es teh manis">
                        ...
                        <div class="p-3 flex flex-col gap-1">
                            ...
                            <p class="text-xs text-gray-400 leading-snug">Es teh manis segar</p>
                            <div class="flex items-center justify-between mt-2">
                    ...
                    <a href="/menu/es-jeruk"
                       ...
                       data-name="es jeruk">
                        ...
                        <div class="p-3 flex flex-col gap-1">
                            ...
                            <p class="text-xs text-gray-400 leading-snug">Es jeruk peras asli</p>
                            <div class="flex items-center justify-between mt-2">
                    ...
                    <a href="/menu/es-kopi-susu"
                       ...
                       data-name="es kopi susu">
                        ...
                        <div class="p-3 flex flex-col gap-1">
                            ...
                            <p class="text-xs text-gray-400 leading-snug">Kopi susu dingin creamy</p>
                            <div class="flex items-center justify-between mt-2">
                    ...
                    <a href="/menu/air-mineral"
                       ...
                       data-name="air mineral">
                        ...
                        <div class="p-3 flex flex-col gap-1">
                            ...
                            <p class="text-xs text-gray-400 leading-snug">Botol 600ml</p>
                            <div class="flex items-center justify-between mt-2">
                    ...
                    <a href="/menu/tahu-krispi"
                       ...
                       data-name="tahu krispi">
                        ...
                        <div class="p-3 flex flex-col gap-1">
                            ...
                            <p class="text-xs text-gray-400 leading-snug">Tahu goreng renyah + cabai</p>
                            <div class="flex items-center justify-between mt-2">
                    ...
                    <a href="/menu/tempe-mendoan"
                       ...
                       data-name="tempe mendoan">
                        ...
                        <div class="p-3 flex flex-col gap-1">
                            ...
                            <p class="text-xs text-gray-400 leading-snug">Tempe tepung goreng setengah matang</p>
                            <div class="flex items-center justify-between mt-2">
                                <span class="text-sm font-extrabold" style="color:#FF6900;">Rp 5.000</span>
                                <div class="add-btn w-7 h-7 rounded-full border-2 flex items-center justify-center text-gray-300 border-gray-200">
                                    <i class="fa-solid fa-plus text-[10px]"></i>
