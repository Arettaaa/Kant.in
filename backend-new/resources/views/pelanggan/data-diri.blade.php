...
<div class="flex w-full h-screen bg-[#F9FAFB] overflow-hidden">
    ...
    <main class="flex-1 flex flex-col h-screen overflow-y-auto bg-[#F9FAFB]">
        ...
        <div class="px-10 pt-8 pb-6 bg-white border-b border-gray-100">
            <h1 class="text-lg font-extrabold text-gray-900">Data Diri</h1>
            <p class="text-sm text-gray-400 font-medium mt-0.5">Informasi detail profil Anda</p>
        </div>
        </div>
                ...
                <div class="flex flex-col gap-5">
                    ...
                    <div>
                        ...
                        <div class="input-wrap">
                            ...
                            <input type="text" class="input-field text-gray-400" value="Yumna Aqila" placeholder="Nama lengkap Anda" readonly>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="input-wrap">
                            ...
                            <input type="tel" class="input-field text-gray-400" value="+62 812-3456-7890" placeholder="Nomor telepon Anda" readonly>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="input-wrap">
                            ...
                            <input type="email" class="input-field text-gray-400" value="yumnaaqila@ipb.ac.id" placeholder="Email Anda" readonly>
                        </div>
                    </div>
                     ...
                     <div>
                        ...
                        <div class="input-wrap">
                            ...
                            <input type="text" class="input-field text-gray-400" value="Gedung CA SV IPB, CA B01 lt.2, Kampus IPB Cilibende " placeholder="Alamat lengkap Anda" readonly>
                        </div>
                    </div>
                 ...
                 {{-- Edit button --}}
                <a href="/profil/edit"
                   class="edit-btn mt-8 w-full py-4 rounded-2xl text-white font-extrabold text-sm shadow-lg flex items-center justify-center"
