<aside
    ...
    <nav class="flex flex-col gap-2 flex-1">
        <a href="{{ route('admin.pesanan') }}" class="flex items-center gap-3 px-4 py-3 rounded-2xl text-[15px] font-bold transition-all
        ...
        <a href="{{ route('admin.menu') }}" class="flex items-center gap-3 px-4 py-3 rounded-2xl text-[15px] font-bold transition-all
        {{ request()->routeIs('admin.menu*') ? 'text-[#FF6900]' : 'text-gray-400 hover:bg-gray-50' }}"
            style="{{ request()->routeIs('admin.menu*') ? 'background-color:#FFF3E8;' : '' }}">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <a href="{{ route('admin.riwayat') }}" class="flex items-center gap-3 px-4 py-3 rounded-2xl text-[15px] font-bold transition-all
